...
# SRC_URI += "crate://crates.io/updatehub/2.1.0"
SRC_URI += "git://github.com/UpdateHub/updatehub.git;nobranch=1;protocol=https"
...
SRC_URI += " \
    ...
    crate://crates.io/assert-json-diff/2.0.1 \
    ...
    crate://crates.io/compress-tools/0.12.2 \
    crate://crates.io/concurrent-queue/1.2.2 \
    crate://crates.io/conpty/0.2.1 \
    ...
    crate://crates.io/easy_process/0.2.0 \
    ...
    crate://crates.io/expectrl/0.2.0 \
    crate://crates.io/fastrand/1.6.0 \
    crate://crates.io/find-binary-version/0.4.0 \
    ...
    crate://crates.io/mockito/0.30.0 \
    ...
    crate://crates.io/output_vt100/0.1.2 \
    ...
    crate://crates.io/pretty_assertions/1.0.0 \
    ...
    crate://crates.io/ptyprocess/0.2.0 \
    ...
    crate://crates.io/windows/0.19.0 \
    crate://crates.io/windows_gen/0.19.0 \
    crate://crates.io/windows_macros/0.19.0 \
    crate://crates.io/windows_quote/0.19.0 \
    crate://crates.io/windows_reader/0.19.0 \
    crate://crates.io/winreg/0.7.0 \
    crate://crates.io/yaml-rust/0.4.5 \
    git://github.com/OSSystems/logging_content.git;protocol=https;nobranch=1;name=logging_content;destsuffix=logging_content \
    git://github.com/OSSystems/tokio-take-seek;protocol=http;nobranch=1;name=tokio-take-seek;destsuffix=tokio-take-seek \
"

SRCREV_FORMAT .= "_logging_content"
SRCREV_logging_content = "97c6c3e2a482839a2ee6f45b08afbc2a3c64c3bf"
EXTRA_OECARGO_PATHS += "${WORKDIR}/logging_content"
SRCREV_FORMAT .= "_tokio-take-seek"
SRCREV_tokio-take-seek = "33a6299d1ffd16d17d34c97de2817a5600fd4632"
EXTRA_OECARGO_PATHS += "${WORKDIR}/tokio-take-seek"
...
HOMEPAGE = "https://www.shellhub.io"
LICENSE = "Apache-2.0"
